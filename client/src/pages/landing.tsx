...
export default function Landing() {
  ...
  const testimonials = [
    {
      quote: "O Instituto Veracity revolucionou nossa operação de campo. A detecção de fraudes em tempo real nos dá confiança total nos dados coletados.",
      author: "Maria Silva",
      ...
      <header className="border-b bg-card/80 backdrop-blur-md fixed w-full z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <img src="/logo-veracity.png" alt="Instituto Veracity" className="h-9 w-auto" />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Veja o que nossos clientes dizem sobre o Instituto Veracity
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">
                  Por que Institutos Escolhem o Instituto Veracity?
                </h2>
        ...
        <section className="py-20 px-4 bg-primary text-primary-foreground">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              Junte-se a centenas de institutos que já confiam no Instituto Veracity para entregar resultados precisos e auditáveis.
            </p>
        ...
        <footer className="py-12 px-4 border-t">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="pt-8 border-t text-center text-sm text-muted-foreground">
              <p>© 2025 Instituto Veracity. Todos os direitos reservados.</p>
            </div>
          </div>
        </footer>
      </main>
